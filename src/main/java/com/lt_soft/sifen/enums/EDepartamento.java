...
public enum EDepartamento {
    ...
    EDepartamento(short val, String descripcion) {
        this.val = val;
        this.descripcion = descripcion;
    }

    public static EDepartamento getByVal(short val) {
        return Arrays.stream(EDepartamento.values()).filter(e -> e.val == val).findFirst().orElse(null);
    }
