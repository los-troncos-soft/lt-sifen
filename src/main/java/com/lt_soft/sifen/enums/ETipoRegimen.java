...
public enum ETipoRegimen {
    ...
    ETipoRegimen(short val, String descripcion) {
        this.val = val;
        this.descripcion = descripcion;
    }

    public static ETipoRegimen getByVal(short val) {
        return Arrays.stream(ETipoRegimen.values()).filter(e -> e.val == val).findFirst().orElse(null);
    }
